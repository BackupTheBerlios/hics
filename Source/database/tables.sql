...
CREATE TABLE Kunde ( KundenNr SERIAL PRIMARY KEY, Nachname VARCHAR(50) NOT NULL, Vorname VARCHAR(50) NOT NULL, PLZ INTEGER, Wohnort VARCHAR(50), Strasse VARCHAR(50), TelNr VARCHAR(25) );
